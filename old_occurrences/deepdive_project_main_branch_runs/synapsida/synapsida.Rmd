...
```{r}
data <- read.csv("C:/Users/SimoesLabAdmin/Documents/BDNN_Arielli/data/synapsida_processed_data/synapsida_deepdive_final.csv", header = TRUE, sep = ",")
head(data)
```
...
```{r}
setwd("C:/Users/SimoesLabAdmin/Documents/DeepDiveR/deepdive_project_main_branch_runs/synapsida/")
