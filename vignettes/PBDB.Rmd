...
URL <- paste0("https://paleobiodb.org/data1.2/occs/list.csv?datainfo&rowcount&base_name=Canidae&taxon_reso=species&idqual=certain&pres=regular&private&show=loc")

# Pull data through API (this step requires internet access)
Canidae <- utils::read.csv(URL, header = TRUE, stringsAsFactors = FALSE)

# Canidae <- read.csv("data/Canidae.csv", header = TRUE, stringsAsFactors = FALSE, skip = 21)
```
