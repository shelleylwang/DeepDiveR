...
Here, we will assume that dispersal of carnivorans to South America was only possible between 11 and 7 Ma. Regions disappearing instead of connecting can be made by setting the label argument to: label = "end".
