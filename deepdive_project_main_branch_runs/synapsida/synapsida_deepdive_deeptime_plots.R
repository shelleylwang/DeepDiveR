...
setwd("../../../deepdive_project_main_branch_runs/synapsida/synapsida_models/simulations_20250312_lstm64_32_d64_32/")
...
plot_data <- data.frame(
 ...
 ######################## 3. N_LOCS GRAPH ####################################
  ...
  # N_Endemics
  plot_graph(year, data$n_endemics, "Number of Synapsida Endemics", "feature_plots_formatted/n_endemics_formatted.pdf")

  # N_Singletons
  plot_graph(year, data$n_singletons, "Number of Synapsida Singletons", "feature_plots_formatted/n_singletons_formatted.pdf")

  # Range_through_div
  plot_graph(year, data$range_through_div, "Synapsida Range Through Diversity", "feature_plots_formatted/range_through_div_formatted.pdf")
