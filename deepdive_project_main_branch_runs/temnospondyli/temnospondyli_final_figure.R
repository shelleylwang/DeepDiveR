...
setwd("../../../temnospondyli/temnospondyli_models/simulations_20250320_lstm64_32_d64_32/")
...
ggsave("feature_plots_formatted/temnospondyli_final_figure.pdf", combined_plot, width = 25, height = 20)
