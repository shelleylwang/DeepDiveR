...
plot_data <- data.frame(
 ...
 ######################## 3. N_LOCS GRAPH ####################################
  ...
  plot_b <- plot_graph(year, net_diversity, "Reptilia Net Diversification", "feature_plots_formatted/net_diversity_formatted.pdf")
  ...
  ggsave("feature_plots_formatted/reptilia_final_figure_draft.pdf", combined_plot, width = 20, height = 20)
