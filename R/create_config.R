...
#'
#' @param name \code{character}. Name of the analysis, used as a
#'    prefix for all file names linked to an analysis. If multiple analyses
#'    are run with the same name, files are overwritten.
