...
study_area_polygon <- str(us)
View(us)
plot(us$x, us$y, type = "l", xlab = "Longitude", ylab = "Latitude", main = "Shape of 'us'")
# ^ example study area polygon is the shape of the US

# Test creating a rectangular polygon
# Coordinates of the four corners of the rectangle
x_coords <- c(-90, 155, 155, -90, -90)
y_coords <- c(-80, -80, 80, 80, -80)
rectangle_df <- data.frame(x = x_coords, y = y_coords)
print(rectangle_df)
plot(rectangle_df$x, rectangle_df$y, type = "l", xlab = "Longitude", ylab = "Latitude", main = "Rectangle Shape")
